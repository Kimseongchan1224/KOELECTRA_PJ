...
|...|...|........|...|
| 199997 | 5 | 민트색상 예뻐요. 옆 손잡이는 거는 용도로도 사용되네요 ㅎㅎ | 1 |    
| 199998 | 2 | 비추합니다 계란 뒤집을 때 완전 불편해요 ㅠㅠ 코팅도.... | 0 |   
| 199999 | 1 | 주문을 11월6에 시켰는데 11월16일에 배송이 왔네요 .... | 0 |  
| 200000 | 2 | 넉넉한 길이로 주문했는데도 안 맞네요 별로예요 | 0 |  
